...
% mapping parameters
column_number = 34; % CHANGE BASED ON NUMBER OF MAPPING COLUMNS
...
first_point = [0; 0; 0];
wall_offset = 0; % in mm; CHANGE BASED ON PROBE OFFSET FROM THE WALL (DON'T ACCOUNT FOR PROBE THICKNESS)
...
grid_resolution = 20; % CHANGE TO INCREASE PLOT RESOLUTION
